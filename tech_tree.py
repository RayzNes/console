...
class ResearchNode:
    def __init__(self, node_id, name, category, year_available, base_cost, base_months,
                 prerequisites=None, effects=None, coords=(0, 0)):
        ...
        self.coords = coords  # Абсолютные координаты (x, y) для рендеринга дерева технологий
