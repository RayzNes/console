...
# Сроки доставки кремниевых пластин (Lead Time)
PRODUCTION_LEAD_TIME = {
    "small": 1,    # 1 месяц для партии 10k
    "medium": 2,   # 2 месяца для партии 50k
    "large": 3     # 3 месяца для партии 100k
}

# Шкала ставок роялти со сторонних игр
ROYALTY_RATES = {
    "weak_bargaining": 0.10,      # Слабая позиция на рынке
    "normal": 0.15,               # Стандартный контракт
    "strong_bargaining": 0.22,    # Сильная позиция
    "exclusive": 0.30             # Эксклюзивные хиты
}

# Сезонность продаж (влияние праздников)
SEASONAL_FACTORS = {
    1: 0.6,   # Январь (затишье)
    2: 0.7,
    3: 0.8,
    4: 0.9,
    5: 1.0,
    ...
    8: 0.9,
    9: 1.0,
    10: 1.2,  # Осенний подъем
    11: 1.5,  # Черная пятница
    12: 1.8   # Рождественский пик спроса
}